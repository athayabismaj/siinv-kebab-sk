<div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between mb-2">
    <div class="flex-1 w-full overflow-hidden">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-white mb-2">Arsip Menu</h1>

        <p class="text-sm text-slate-500 dark:text-slate-400 max-w-2xl leading-relaxed">
            Daftar menu yang telah dinonaktifkan. Menu ini tidak akan muncul di kasir, namun dapat dipulihkan kapan saja jika diperlukan.
        </p>
    </div>

    <div class="shrink-0 mt-2 lg:mt-0">
        <a href="{{ route('admin.menus.index') }}" class="inline-flex w-full sm:w-auto items-center justify-center gap-2 px-5 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-200 text-[13px] font-semibold rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-slate-300 transition-all shadow-sm">
