<form method="GET" action="{{ route($usageRoute) }}" id="filter-form" class="relative z-10 py-2">
    ...
    <div class="grid grid-cols-1 gap-3 w-full lg:items-center {{ ($branchOptions ?? collect())->isNotEmpty() ? 'lg:grid-cols-[auto_minmax(260px,1fr)_14rem_auto]' : 'lg:grid-cols-[auto_minmax(260px,1fr)_auto]' }}">
