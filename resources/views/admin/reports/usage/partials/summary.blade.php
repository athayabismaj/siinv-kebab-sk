...
<div class="grid grid-cols-2 md:grid-cols-{{ $cols }} gap-4">
    ...
    <div class="relative overflow-hidden p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm hover:shadow-md transition group">
        ...
        <p class="text-2xl font-black text-slate-900 dark:text-white tabular-nums">{{ number_format($summary['ingredients_count']) }}</p>
    ...
    <div class="relative overflow-hidden p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm hover:shadow-md transition group">
        ...
        <p class="text-2xl font-black text-slate-900 dark:text-white tabular-nums">{{ number_format($summary['logs_count']) }}</p>
        <p class="text-[10px] text-slate-400 mt-1">log pemakaian</p>
