...
<div class="w-full space-y-6 overflow-x-hidden pb-10">
    ...
    <form id="filter-form" method="GET" action="{{ route('admin.reports.daily-stock') }}" data-period-filter class="flex flex-col lg:flex-row gap-3 w-full items-center justify-between py-2 relative z-10">
...
@push('styles')
@vite('resources/css/pages/daily-stock-report.css')
@endpush
@endsection
