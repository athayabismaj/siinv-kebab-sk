...
<div class="w-full space-y-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm font-medium leading-relaxed text-slate-500 dark:text-slate-400 max-w-3xl">
            Perbarui kata sandi untuk akun pengguna ini. Pastikan Anda memberikan kata sandi baru yang kuat, <br class="hidden sm:block mt-1">lalu beritahukan kata sandi tersebut kepada yang bersangkutan.
        </p>
    </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3 px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 transition-all overflow-hidden">
                            ...
                            <button type="button" onclick="togglePassword('new_password', 'icon_new_pwd')" class="shrink-0 text-slate-400 hover:text-blue-500 transition-colors focus:outline-none">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3 px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 transition-all overflow-hidden">
                            ...
                            {{-- Tombol Mata Kanan (Hide/Show) --}}
                            <button type="button" onclick="togglePassword('confirm_password', 'icon_confirm_pwd')" class="shrink-0 text-slate-400 hover:text-blue-500 transition-colors focus:outline-none">
...
<script>
    function togglePassword(inputId, iconId) {
        ...
        if (input.type === 'password') {
            // Tampilkan Password (Ganti icon ke mata terbuka)
            input.type = 'text';
            icon.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />';
        } else {
            // Sembunyikan Password (Ganti icon ke mata tercoret)
            input.type = 'password';
