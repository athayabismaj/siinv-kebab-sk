        ...
        <div class="relative" x-data="{ openNotification: false }">
            ...
            <div x-show="openNotification"
                ...
                <div class="px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                    ...
                    @if(($lowStockCount ?? 0) > 0)
                        <span class="px-2 py-0.5 rounded-full bg-red-100 text-red-600 text-[10px] font-bold">{{ $lowStockCount }} Baru</span>
                    @endif
                </div>
                
                <div class="max-h-64 overflow-y-auto">
                    @if(($lowStockCount ?? 0) > 0)
                    <a href="{{ $stockRoute }}" class="block p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors border-l-4 border-red-500">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-xs font-bold text-slate-800 dark:text-slate-200">Stok Hampir Habis!</p>
                                <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-relaxed">Ada <strong>{{ $lowStockCount }} bahan</strong> yang perlu segera disuplai. Klik untuk melihat detailnya.</p>
                            </div>
                        </div>
                    </a>
                    @else
